...
export function App(props: {
  ...
  const checkBackendConnection = useCallback(async () => {
    ...
    try {
      ...
      console.error('Connection failed:', error)
      setBackendStatus(`❌ LOOOOL YOU FAILED TO CONNECT LMAO: ${error.message}`)
    }
  }, [])
  ...
  const sendDataToBackend = useCallback(async () => {
    try {
      ...
      if (!response.ok) {
        throw new Error(`YOU CANNOT SEND SHIT BRO! HTTP Error btw status: ${response.status}`)
      }
      ...
      console.error('Error sending data:', error)
      setBackendStatus(`❌ You suck at sending data bruhhh this is the last error catch: ${error.message}`)
    }
  }, [])
    ...
    <view>
      ...
      <view className='App'>
        ...
        <view className='Content'>
          ...
          <view bindtap={checkBackendConnection} className='TestButton'>
            <text>Test Connection</text>
          </view>
          
          <view bindtap={sendDataToBackend} className='SendButton'>
            <text>Send Data</text>
          </view>
        </view>
